...
namespace hw5
{
	...
	public class AsianOptionsPricing
	{
		...
		///
		public static double Simulation(double initial, double exercise, double up, double down, double interest, long periods, long sims)
		{
			// need a random number generator for Monte Carlo simulations:
